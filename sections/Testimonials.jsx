...
const Testimonials = () => {
  return (
    <div className="md:mt-20 mt-10 max-sm:gap-6 flex-col md:flex-row flex">
      {/* First Card */}
      <div className="lg:h-[37vh] cursor-pointer hover:bg-[#cfcac5] shadow-xl h-[18vh] md:h-[20vh] peer/cardOne rounded-2xl transition-all ease-in-out duration-500 bg-[#dfd8d2] min-w-[37vw] flex items-center justify-center border-2 border-[#1b1b1d] ">
        <div className="border-4 p-4  flex flex-col justify-between border-dashed rounded-xl w-[95%] h-[90%] mx-auto  border-[#1b1b1d] ">
          ...
          <div className="flex gap-2 items-center">
            <img
              className="rounded-full w-[23px] h-[23px] md:w-[50px] md:h-[50px] "
      ...
      {/* Second Card */}
      <div className="lg:h-[37vh] cursor-pointer hover:bg-[#cfcac5]  shadow-xl h-[18vh] md:h-[20vh] peer/cardTwo md:-translate-x-[50%] transition-all ease-in-out duration-500 bg-[#dfd8d2] sm:peer-hover/cardOne:-translate-x-[5%]  rounded-2xl  min-w-[37vw] flex items-center justify-center border-2 border-[#1b1b1d] ">
        <div className="border-4 flex flex-col justify-between p-4   border-dashed rounded-xl w-[95%] h-[90%] mx-auto border-[#1b1b1d] ">
          ...
          <div className="flex gap-2 items-center">
            <img
              className="rounded-full object-cover  w-[23px] h-[23px] md:w-[50px] md:h-[50px]  "
      ...
      {/* Third Card */}
      <div className="lg:h-[37vh] max-sm:hidden cursor-pointer hover:bg-[#cfcac5] shadow-xl h-[20vh] peer/cardThree md:-translate-x-[100%] transition-all ease-in-out duration-500 bg-[#dfd8d2] peer-hover/cardOne:-translate-x-[70%] peer-hover/cardTwo:-translate-x-[70%]   rounded-2xl  min-w-[37vw] flex items-center justify-center border-2 border-[#1b1b1d] ">
        <div className="border-4 flex flex-col justify-between p-4  border-dashed rounded-xl w-[95%] h-[90%] mx-auto border-[#1b1b1d] ">
      ...
      {/* Fourth Card */}
      <div className="lg:h-[37vh] max-sm:hidden cursor-pointer hover:bg-[#cfcac5] shadow-xl h-[20vh] -translate-x-[150%] transition-all ease-in-out duration-500 bg-[#dfd8d2] peer-hover/cardOne:-translate-x-[120%] peer-hover/cardTwo:-translate-x-[120%] peer-hover/cardThree:-translate-x-[120%]   rounded-2xl  min-w-[37vw] flex items-center justify-center border-2 border-[#1b1b1d] ">
        <div className="border-4 flex flex-col justify-between p-4  border-dashed rounded-xl w-[95%] h-[90%] mx-auto border-[#1b1b1d] ">
